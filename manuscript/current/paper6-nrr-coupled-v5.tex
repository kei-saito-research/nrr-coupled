...
\begin{itemize}
  ...
  \item \textbf{Zero-movement handling}: v4 counts near-zero movement (\(|\Delta w|\le\) tolerance) as violation. This is intentionally conservative and can slightly overcount violations in clipping-saturation turns.
...
Artifacts:
\begin{itemize}
  \item `spec/nrr-coupled\_spec\_v5.md`
  \item `repro/coupled\_state\_sim.py`
  \item `repro/README\_v5.md`
