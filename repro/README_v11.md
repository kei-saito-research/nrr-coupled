# NRR-Coupled v11 Reproducibility (Dependency-Consistency Protocol)

## Scope
This v11 protocol reproduces:
- `manuscript/current/paper6-nrr-coupled-v11.tex` (workspace layout)
- `manuscript/paper6-nrr-coupled-v11.tex` (handoff ZIP layout)
- `spec/nrr-coupled_spec_v8.md`
- `repro/coupled_state_sim.py`
The simulation specification file remains `v8` by design; manuscript revisions from v9 onward are editorial and do not change simulation logic or outputs.
...
tectonic -X compile paper6-nrr-coupled-v11.tex
```

Expected output:
- `manuscript/current/paper6-nrr-coupled-v11.pdf`
- `manuscript/paper6-nrr-coupled-v11.pdf` (handoff ZIP layout)
