# NRR-Coupled v5 Reproducibility (Dependency-Consistency Protocol)

## Scope
This v5 protocol reproduces:
- `manuscript/current/paper6-nrr-coupled-v5.tex`
- `spec/nrr-coupled_spec_v5.md`
...
tectonic -X compile paper6-nrr-coupled-v5.tex
```

Expected output:
- `manuscript/current/paper6-nrr-coupled-v5.pdf`

Interpretation notes:
- In `D-independent`, `A_eval=0` so violation opportunities are zero; use
  `cp_v4_independent_check.csv` equality checks for substantive confirmation.
