# NRR-Coupled v8 Reproducibility (Dependency-Consistency Protocol)

## Scope
This v8 protocol reproduces:
- `manuscript/paper6-nrr-coupled-v8.tex`
...
```bash
cd manuscript
tectonic -X compile paper6-nrr-coupled-v8.tex
```

Expected output:
- `manuscript/paper6-nrr-coupled-v8.pdf`
