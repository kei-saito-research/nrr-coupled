# NRR-Coupled v10 Reproducibility (Dependency-Consistency Protocol)

## Scope
This v10 protocol reproduces:
- `manuscript/current/paper6-nrr-coupled-v10.tex`
...
tectonic -X compile paper6-nrr-coupled-v10.tex
```

Expected output:
- `manuscript/current/paper6-nrr-coupled-v10.pdf`
